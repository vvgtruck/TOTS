            ...
            })
            {
                ...
                using (SqlDataReader rdr = command.ExecuteReader())
                {
                    ...
                    while (rdr.Read())
                    {
                        ...
                        techTimeSheetCalc.LaborGuideActual = (float.Parse(rdr["LaborGuideActual"].ToString())).ToString("0.00") + " Hrs";
                        techTimeSheetCalc.LaborGuideBill = (float.Parse(rdr["LaborGuideBill"].ToString())).ToString("0.00") + " Hrs";
                        techTimeSheetCalc.AttendenceWeek = (float.Parse(rdr["AttendenceWeek1"].ToString()) + float.Parse(rdr["AttendenceWeek2"].ToString())).ToString("0.00") + " Hrs";
                        //techTimeSheetCalc.AttendenceWeek2 = float.Parse(rdr["AttendenceWeek2"].ToString());
                        techTimeSheetCalc.OvertimeWeek = (float.Parse(rdr["OvertimeWeek1"].ToString()) + float.Parse(rdr["OvertimeWeek2"].ToString())).ToString("0.00") + " Hrs";
                        ...
                        techTimeSheetCalc.IdletimeWeek = (float.Parse(rdr["IdletimeWeek1"].ToString()) + float.Parse(rdr["IdletimeWeek2"].ToString())).ToString("0.00") + " Hrs";
                        ...
                        techTimeSheetCalc.ProductionTime = (float.Parse(rdr["ProductionTime"].ToString())).ToString("0.00") + " Hrs";
                        techTimeSheetCalc.Efficiency = (float.Parse(rdr["Efficiency"].ToString()) * 100).ToString("0.00") + "%";
                        techTimeSheetCalc.Productivity = (float.Parse(rdr["Productivity"].ToString()) * 100 ).ToString("0.00") + "%";
